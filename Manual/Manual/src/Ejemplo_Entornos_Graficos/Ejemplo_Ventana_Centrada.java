...
class VentanaCentrada extends JFrame {
    ...
    public VentanaCentrada() {
        ...
        // Imagen miLogo = mipantalla.getImage ("Manual / src / Ejemplo_Entornos_Graficos / logo.jpg"); asi estariamos obligando a guardar la imagen dentro de la carpeta Ejemplos entormos graficos
        Image miLogo = mipantalla.getImage("logo.jpg");

        setIconImage(miLogo);

        // setIconImage (mipantalla.getImage ("logo.jpg")); modo abrebiado del dos líneas de codigos anteriores
    }
